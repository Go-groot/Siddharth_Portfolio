  ...
  return (
    <div className='hidden fixed z-10 lg:flex items-center justify-center bottom-0 left-8 min-w-[30px] min-h-[300px]'>
        <div className='flex flex-col gap-7 text-[1.3rem] text-gray-200 px-4 pt-2 h-full'>
            ...
            <a href='mailto:Siddharthsharma0606@outlook.com?&subject=Hey Sid..&body=Cool portfolio website!'><div title='Gmail' className='hover:text-[#05BFDB] hover:-translate-y-1 trasnition transition-transform ease-in-out'><FiMessageSquare /></div></a>
